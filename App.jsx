...
function App() {
  ...
  const CHAT_INIT = [{role:"assistant",content:"👋 Hi! I'm your KidPlan worksheet builder. Tell me what you need and I'll collect everything before building!\n\n💡 Try: 'Maths fractions' or 'Grade 2 English tenses Advanced'",chips:["Build Daily Schedule","Build Weekly Schedule","Grade 2 Maths","Grade 3 English","Hindi Topics"]}];
  ...
  const [notifications,setNotifications] = useState([{id:1,icon:"🔥",text:"Welcome to PadhAI! 🎉",time:"Now",read:false}]);
  ...
  const [analytics,setAnalytics]         = useState(()=>{
    try{ return JSON.parse(localStorage.getItem("padhai_analytics")||"{}"); }catch{ return {}; }
  });
  const [crashLog,setCrashLog]           = useState(()=>{
    try{ return JSON.parse(localStorage.getItem("padhai_crashes")||"[]"); }catch{ return []; }
  });
  ...
  const buildPrintHTML = (apps) => {
      ...
      return `<div style="font-family:Arial,sans-serif;padding:28px 32px;max-width:760px;margin:0 auto;${idx>0?"page-break-before:always;":""}">
        ...
        <div style="border-bottom:3px solid #6C63FF;padding-bottom:14px;margin-bottom:22px;">
          <div style="display:flex;justify-content:space-between;align-items:flex-start;">
            <div>
              <div style="font-size:11px;color:#999;letter-spacing:1px;text-transform:uppercase;">KidPlan · NCERT/CBSE Worksheet</div>
    ...
    return `<!DOCTYPE html><html lang="en"><head>
      <meta charset="UTF-8"/>
      <title>KidPlan Worksheets — ${new Date().toLocaleDateString("en-IN")}</title>
      <style>
      ...
      <div class="no-print" style="position:fixed;top:0;left:0;right:0;background:#6C63FF;color:#fff;padding:12px 24px;display:flex;justify-content:space-between;align-items:center;z-index:99;font-family:Arial;">
        <span style="font-weight:700;font-size:15px;">📚 KidPlan — ${apps.length} Worksheet${apps.length>1?"s":""} Ready</span>
...
I'll set it up for a **${sType}** schedule — you can add topics day by day and I'll build your worksheet plan.`,chips:[]}
  ...
  const track = useCallback((event, data={}) => {
    ...
    setAnalytics(prev => {
      ...
      try{ localStorage.setItem("padhai_analytics", JSON.stringify(updated)); }catch{}
      return updated;
    });
  }, []);
  ...
  const logError = useCallback((error, context="unknown") => {
    ...
    setCrashLog(prev => {
      ...
      try{ localStorage.setItem("padhai_crashes", JSON.stringify(updated)); }catch{}
      return updated;
    });
  ...
  const CertificateModal = showCertModal && certMonth ? (()=>{
      ...
      <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.7)",zIndex:400,display:"flex",alignItems:"center",justifyContent:"center",padding:16}}
        ...
        <div onClick={e=>e.stopPropagation()}
          ...
          <div style={{padding:"20px 24px"}}>
            ...
            <div style={{fontSize:11,color:"#ccc",textAlign:"center",marginBottom:14}}>Issued by PadhAI · {today}</div>
  ...
  if(screen==="splash") return (
    <div style={{fontFamily:"'Nunito',sans-serif",background:"linear-gradient(135deg,#6C63FF,#FF6B6B)",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:24,padding:24}}>
      ...
      <div className="pop" style={{textAlign:"center",color:"#fff"}}>
        ...
        <div style={{fontFamily:"'Fredoka One'",fontSize:44}}>PadhAI</div>
  ...
  if(screen==="p-login") return (
    <div style={{fontFamily:"'Nunito',sans-serif",background:"#F0EFFE",display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh"}}>
      ...
      <div className="card fadeUp" style={{padding:36,maxWidth:380,width:"100%",textAlign:"center"}}>
        ...
        <p style={{color:"#888",fontSize:14,marginBottom:22}}>Plan your child's NCERT learning</p>
            ...
            <div key={idx} className="ws-page" style={{padding:28}}>
              ...
              <div style={{borderBottom:"3px solid #6C63FF",paddingBottom:14,marginBottom:20}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:8}}>
                  <div>
                    <div style={{fontSize:10,color:"#999",letterSpacing:1,textTransform:"uppercase",fontFamily:"Nunito"}}>KidPlan · NCERT/CBSE · Worksheet {idx+1}/{apps.length}</div>
              ...
              <div style={{marginTop:18,paddingTop:8,borderTop:"1px solid #eee",display:"flex",justifyContent:"space-between",fontSize:11,color:"#ccc"}}>
                <span>KidPlan · NCERT Worksheet</span>
                <span>Generated {new Date().toLocaleDateString("en-IN")}</span>
              </div>
            </div>
          );
  ...
  if(screen==="dashboard") {
    ...
    <div style={{fontFamily:"'Nunito',sans-serif",background:"#F0EFFE",minHeight:"100vh"}}>
      ...
      <div style={{background:"#fff",boxShadow:"0 2px 8px #00000008",padding:"10px 18px",display:"flex",gap:8,maxWidth:760,margin:"0 auto",borderRadius:"0 0 14px 14px",position:"sticky",top:0,zIndex:90}}>
        {[{id:"overview",label:"📋 Overview"},{id:"subjects",label:"📚 Subjects"},{id:"activity",label:"📜 Activity"}].map(t=>(
          ...
          return(
            <div style={{padding:"16px 0"}}>
              ...
              <button className="btn" onClick={()=>{
                ...
                const a=document.createElement("a");a.href=url;a.download="padhai_analytics.json";a.click();URL.revokeObjectURL(url);
          ...
          <div style={{padding:"16px 0"}}>
            ...
            {crashLog.length===0?(
              ...
              <div>
                ...
                <button className="btn" onClick={()=>{setCrashLog([]);localStorage.removeItem("padhai_crashes");}}
