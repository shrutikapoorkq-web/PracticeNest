  ...
  "Hindi||संज्ञा (Nouns)": {
    Beginner: {title:"संज्ञा — Beginner",grade:"Grade 2",subject:"Hindi",level:"Beginner",
      ...
      sections:[{heading:"संज्ञा पहचानिए",section_label:"क",questions:[
        ...
        {id:4,type:"fill",prompt:"नीचे दिए शब्दों में से संज्ञा छाँटिए: चलना, किताब, लाल
उत्तर: ___",answer:"किताब",marks:2},
  ...
  return (
    ...
    try {
      ...
      document.getElementById('root').innerHTML = 
        '<div style="padding:40px;text-align:center;font-family:sans-serif;color:red">' +
        '<h2>Error loading app</h2><pre>' + e.message + '</pre></div>';
    }